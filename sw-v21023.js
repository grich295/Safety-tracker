const SHELL_CACHE='safety-shell-v21023-loginfix';
const RUNTIME_CACHE='safety-runtime-v21023-loginfix';
const SHELL=['./','./index.html','./styles-v21023.css','./app-v21023.js','./bulk-import-v2100.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
