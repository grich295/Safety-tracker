const SHELL_CACHE='safety-shell-v21017';
const RUNTIME_CACHE='safety-runtime-v21017';
const SHELL=['./','./index.html','./styles-v21017.css','./app-v21017.js','./bulk-import-v2100.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
