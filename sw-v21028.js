const SHELL_CACHE='safety-shell-v21056-review-audit';
const RUNTIME_CACHE='safety-runtime-v21056-review-audit';
const SHELL=['./','./index.html','./styles-v21019.css','./app-v21028.js','./hotfix-v21046-baseline.js','./hotfix-v21055-training-packs.js','./hotfix-v21056-review-audit.js','./bulk-import-v21028.js','./demo-v2100.js','./config.js','./manifest.webmanifest','./version.json'];
const RUNTIME=[
