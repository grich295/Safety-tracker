const SHELL_CACHE='safety-shell-v21058-ssw-revision';
const RUNTIME_CACHE='safety-runtime-v21058-ssw-revision';
const SHELL=['./','./index.html','./styles-v21019.css','./app-v21028.js','./hotfix-v21046-baseline.js','./hotfix-v21055-training-packs.js','./hotfix-v21056-review-audit.js','./hotfix-v21057-linked-impact.js','./hotfix-v21058-app-created-ssw-revision.js','./bulk-import-v21028.js','./demo-v2100.js','./config.js','./manifest.webmanifest','./version.json'];
const RUNTIME=[
