const SHELL_CACHE='safety-shell-v21031-ptw-stability';
const RUNTIME_CACHE='safety-runtime-v21031-ptw-stability';
const SHELL=['./','./index.html','./styles-v21019.css','./app-v21028.js','./hotfix-v21029-core.js','./hotfix-v21029-ui.js','./hotfix-v21029-exception.js','./hotfix-v21030-ptw.js','./hotfix-v21031-ptw-stability.js','./bulk-import-v21028.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
