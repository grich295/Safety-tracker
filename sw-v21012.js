const SHELL_CACHE='safety-shell-v21012';
const RUNTIME_CACHE='safety-runtime-v21012';
const SHELL=['./','./index.html','./styles-v21012.css','./app-v21012.js','./bulk-import-v2100.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
