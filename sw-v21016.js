const SHELL_CACHE='safety-shell-v21016';
const RUNTIME_CACHE='safety-runtime-v21016';
const SHELL=['./','./index.html','./styles-v21016.css','./app-v21016.js','./bulk-import-v2100.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
