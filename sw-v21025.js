const SHELL_CACHE='safety-shell-v21025-training-schedule';
const RUNTIME_CACHE='safety-runtime-v21025-training-schedule';
const SHELL=['./','./index.html','./styles-v21024.css','./app-v21025.js','./bulk-import-v21025.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
