const SHELL_CACHE='safety-shell-v21021-loginfix';
const RUNTIME_CACHE='safety-runtime-v21021-loginfix';
const SHELL=['./','./index.html','./styles-v21021.css','./app-v21021.js','./bulk-import-v2100.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
