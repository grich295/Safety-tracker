/* Safety Tracker v2.7.1 - robust file open + demo mode + retained password recovery. */
'use strict';

const APP_VERSION='2.7.1';
const BUILD_ID='v271-file-open-recovery-20260912';
...
function installActionRouter(){
  ...
  window.__SAFETY_ACTION_ROUTER='v2.6.3-capture';
}
...
async function forgotPassword(){
  ...
  const redirectTo=`${SAFETY_APP_URL}?recovery=1&build=270`;
