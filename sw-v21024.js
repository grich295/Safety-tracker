const SHELL_CACHE='safety-shell-v21024-loginfix';
const RUNTIME_CACHE='safety-runtime-v21024-loginfix';
const SHELL=['./','./index.html','./styles-v21024.css','./app-v21024.js','./bulk-import-v2100.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
