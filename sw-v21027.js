const SHELL_CACHE='safety-shell-v21027-startup-fix';
const RUNTIME_CACHE='safety-runtime-v21027-startup-fix';
const SHELL=['./','./index.html','./styles-v21024.css','./app-v21027.js','./bulk-import-v21027.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
