const SHELL_CACHE='safety-shell-v21026-central-version';
const RUNTIME_CACHE='safety-runtime-v21026-central-version';
const SHELL=['./','./index.html','./styles-v21024.css','./app-v21026.js','./bulk-import-v21026.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
