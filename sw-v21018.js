const SHELL_CACHE='safety-shell-v21018';
const RUNTIME_CACHE='safety-runtime-v21018';
const SHELL=['./','./index.html','./styles-v21018.css','./app-v21018.js','./bulk-import-v2100.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
