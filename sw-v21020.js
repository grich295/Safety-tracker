const SHELL_CACHE='safety-shell-v21020-loginfix';
const RUNTIME_CACHE='safety-runtime-v21020-loginfix';
const SHELL=['./','./index.html','./styles-v21020.css','./app-v21020.js','./bulk-import-v2100.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
