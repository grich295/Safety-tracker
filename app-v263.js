/* Safety Tracker v2.6.3 - hard button router + password recovery repair. */
'use strict';

const APP_VERSION='2.6.3';
const BUILD_ID='v263-hard-button-router-password-recovery-20260912';
...
async function forgotPassword(){
  ...
  const redirectTo=`${SAFETY_APP_URL}?recovery=1&build=263`;
