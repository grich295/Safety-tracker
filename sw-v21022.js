const SHELL_CACHE='safety-shell-v21022-loginfix';
const RUNTIME_CACHE='safety-runtime-v21022-loginfix';
const SHELL=['./','./index.html','./styles-v21022.css','./app-v21022.js','./bulk-import-v2100.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
