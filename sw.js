const CACHE='safety-tracker-v1-8-0';
const CORE=['./','./index.html','./app-v161.js','./bulk-import-v161.js','./app-v171-patch.js','./app-v180-architecture.js','./config.js','./manifest.webmanifest'];
