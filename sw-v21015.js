const SHELL_CACHE='safety-shell-v21015';
const RUNTIME_CACHE='safety-runtime-v21015';
const SHELL=['./','./index.html','./styles-v21015.css','./app-v21015.js','./bulk-import-v2100.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
