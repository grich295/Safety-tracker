/* Safety Tracker v2.3.7 - simplified user experience + role/access hardening. */
'use strict';

const APP_VERSION='2.3.7';
const BUILD_ID='v237-simple-user-my-safety-20260911';
