const SHELL_CACHE='safety-shell-v21013';
const RUNTIME_CACHE='safety-runtime-v21013';
const SHELL=['./','./index.html','./styles-v21013.css','./app-v21013.js','./bulk-import-v2100.js','./demo-v2100.js','./config.js','./manifest.webmanifest'];
const RUNTIME=[
